  ...
  const metricCards = [
    ...
    },
    {
      ...
      value: formatPercentage(
        (discountAnalysis.totalRevenue + discountAnalysis.totalDiscounts) > 0
          ? (discountAnalysis.totalDiscounts / (discountAnalysis.totalRevenue + discountAnalysis.totalDiscounts)) * 100
          : 0
      ),
      icon: Percent,
