    ...
    <footer className="mt-8 border-t border-border/70 py-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif text-[15px] tracking-tight">Analytics Hub</span>
          <span className="hidden text-[11px] text-muted-foreground sm:inline">· Physique 57 · Advanced Business Analytics</span>
        </div>
